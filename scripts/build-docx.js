...
children.push(
  ...
  bullet('參與者可透過 yichengstudio@gmail.com 申請查詢、更正、取消或刪除資料。'),
  callout('上線前必要設定', [
    'HTML 報名頁已預留 Google Apps Script／Google 試算表後端。正式開放前須設定收件端點、試算表權限與 50 席容量，確認主辦聯絡信箱為 yichengstudio@gmail.com，並完成一筆真實測試後刪除測試資料。',
  ], 'warning'),
  ...
  compactNumbered('確認主辦聯絡信箱與個資查詢／刪除窗口為 yichengstudio@gmail.com。'),
